...
module.exports = {
    ...
    name: ['kayıtsız', 'kayıtsiz','kayitsiz'], //arraya istediğiniz kadar kullanım yazabilirsiniz alieses gibi saçma bir şeyle uğraşmak yerine direk arraya ekleyebilirsiniz.
